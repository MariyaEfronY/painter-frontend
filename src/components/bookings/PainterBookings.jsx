...
const PainterBookings = ({ painterId }) => {
  ...
  const fetchBookings = async () => {
    const res = await axios.get(`https://painter-backend-inky.vercel.app/api/bookings/painter/${painterId}`);
  ...
  const updateStatus = async (id, status) => {
    await axios.put(`https://painter-backend-inky.vercel.app/api/bookings/${id}/status`, { status });
    fetchBookings();
  };
